...
"""
try:
    CONNECTION_STRING = 'localhost:27017' if CONFIG.flask_env == 'development' else "mongodb+srv://" + CONFIG.db_username + ":" + CONFIG.db_password + "@cluster0.izwr5.mongodb.net/?retryWrites=true&w=majority"
